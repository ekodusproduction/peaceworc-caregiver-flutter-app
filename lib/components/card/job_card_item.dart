                        ...
                        Padding(
                            ...
                            child: Skeleton.shade(
                              child: Container(
                                  ...
                                  child: Skeleton.ignore(child: const Icon(Icons.work, size: 30.0,))),
                            )
                        ),
                        const Column(
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Icon(
                                  Icons.star, size: 40, color: Colors.orange,
                                  semanticLabel: "10",
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          Text('\u002425', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color:  Color.fromRGBO(0, 60, 129, 1)),),
                      ...
                      const Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Icon(Icons.arrow_forward_ios_rounded, color: Colors.black, size: 18.0,)
                          ],
                        ),
                      ),
