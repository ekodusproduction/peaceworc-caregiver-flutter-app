...
class DrivingCard extends StatefulWidget {
  final List<Driving>? docs;
  const DrivingCard({super.key, required this.docs});

  @override
  State<DrivingCard> createState() => _DrivingCardState();
}

class _DrivingCardState extends State<DrivingCard> {
  File? _image;
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text( "Driving License", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 14),)
              ],
            ),
          ),
          Padding(
