...
class CriminalCard extends StatefulWidget {
  final List<Criminal>? docs;
  const CriminalCard({super.key, required this.docs});

  @override
  State<CriminalCard> createState() => _CriminalCardState();
}

class _CriminalCardState extends State<CriminalCard> {
  File? _image;
  ...
  Future<void> _openImagePicker() async {
    ...
    if (pickedImage != null) {
      ...
      uploadDocBloc.uploadDoc(_image!, _image!.path.split('/').last, 'criminal', "09-09-2065");
    }
  }
  void openSettings(){
    openAppSettings();
